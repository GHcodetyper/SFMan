...
namespace SFMan
{
	class Program
	{
		static string token = "00DEm000000iVkr!AQEAQOk2XG6uvGQ6Ey.HM1hA3mtohik.3xYLT6nWrass0YzU2aTbW_iBNY5PjgEo42DnWmCScW_bS3S8WPJJpyyojZa8RXmI";
		...
		static void Main(string[] args)
		{
			...
			string e3 = csvContacts.GetContactProperty(con, "Email");
			 ...
			 var csvAccounts = new CSVAccounts(@"c:\temp\SF\Account 2.csv");
